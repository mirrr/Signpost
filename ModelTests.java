...
public class ModelTests {
    ...
    public void arrowDirectionTest(){
        Model model = new Model(tr(SOLN1));
        assertEquals(ARROWS1[0][0], model.arrowDirection(0,model.height()-1));
        assertEquals(ARROWS1[model.width()-1][model.height()-1],
        model.arrowDirection(model.width()-1, 0));
        assertEquals(ARROWS1[model.width()/2][model.height()/2],
        model.arrowDirection(model.width()/2,
        model.height()-1-model.height()/2));
    }*/
